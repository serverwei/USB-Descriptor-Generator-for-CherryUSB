                ...
                case "HID":
                    {
                        ...
                        //Full interface descriptor
                        {
                            ...
                            stringLen += 1;
                            stringTmp += `0x${toHexFormat((interfaceInfo[i]["VendorDefine"]["Enabled"] && (interfaceInfo[i]["VendorDefine"]["Input"]["Id"] || interfaceInfo[i]["VendorDefine"]["Output"]["Id"])) || (interfaceInfo[i]["Mouse"]["Enabled"] && interfaceInfo[i]["Mouse"]["Id"]["Value"]) || (interfaceInfo[i]["Keyboard"]["Enabled"] && interfaceInfo[i]["Keyboard"]["Id"]["Value"]) || (interfaceInfo[i]["Consumer"]["Enabled"] && interfaceInfo[i]["Consumer"]["Id"]["Value"]) ? 0 : 1)},\t\t\t// bInterfaceSubClass\r\n`;
                            stringLen += 1;
